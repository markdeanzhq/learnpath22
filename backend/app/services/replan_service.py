...
def _profile_snapshot_to_dict(snapshot: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "learning_goal_orientation": snapshot.get("learning_goal_orientation"),
        "resource_preference": snapshot.get("resource_preference"),
        "practice_intensity": snapshot.get("practice_intensity", 3),
