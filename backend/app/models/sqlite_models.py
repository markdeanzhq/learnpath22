...
class LearnerProfile(Base):
    ...
    learning_goal_orientation: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    resource_preference: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    practice_intensity: Mapped[int] = mapped_column(Integer, default=3)
