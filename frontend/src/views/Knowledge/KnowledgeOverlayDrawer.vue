  ...
  <el-drawer v-model="visibleModel" title="创建图谱候选草稿" :size="520" direction="rtl">
    <div class="overlay-drawer" v-loading="overlaySubmitting || overlayExtractionPreviewLoading || overlayAutoDraftLoading">
      ...
      <OverlaySessionResultPanel
        ...
        :overlay-batch-planning-loading="overlayBatchPlanningLoading"
        :overlay-batch-plannable-count="overlayBatchPlannableCount"
...
const props = defineProps<{
  ...
  overlayBatchPlanningLoading: boolean
  overlayBatchPlannableCount: number
